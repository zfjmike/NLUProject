...
class Ports:
    ...
    class Input:
        ...
        support_length = TensorPort(np.long, [None], "support_length",
                                    "Represents length of supports in batch",
                                    "[batch_size]")

        question_length = TensorPort(np.long, [None], "question_length",
    ...
    class Target:
        ...
        target_index = TensorPort(np.long, [None], "target_index",
